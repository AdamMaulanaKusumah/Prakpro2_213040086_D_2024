...
public class Tugas02 extends JFrame {
    ...
    public Tugas02() {
        ...
        JButton showPasswordButton = new JButton("\uD83D\uDC41"); // Eye symbol
        ...
        JButton showConfirmPasswordButton = new JButton("\uD83D\uDC41"); // Eye symbol
        ...
        scrollPane.setBounds(15, 585, 350, 200);
        ...
        this.setSize(400, 850); // Adjust size to accommodate content
        this.setLayout(null);
